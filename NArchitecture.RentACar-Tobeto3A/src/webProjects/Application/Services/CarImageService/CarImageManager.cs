...
using Core.CrossCuttingConcers.Utilities.Helpers;
...
public class CarImageManager : ICarImageService
{
    ...
    public async Task<CarImage> Add(IFormFile file, CarImage request)
    {
        ...
        request.ImagePath = FileHelper.Add(file, "CarImages");
        return await _carImageRepository.AddAsync(request);
